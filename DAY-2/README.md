...
Change the user prompt to: 
`
Explain what an OOMKill is and how to fix it in Kubernetes. Use bullet points."
`
...
You will type a request such as:  
```
give me linux command to check for disk space, kubernetes pods status check, aws s3 bucklet list
